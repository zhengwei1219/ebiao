...
if (Object.create) (function() { //my add

    var Object_create = Object.create ? Object.create : function() {
        var T = function() { };
        return function(obj) {
            T.prototype = obj;
            return new T;
    ...
    (function(mod) {
        ...
        function makeScope(prev) {
            return { vars: Object_create(null), prev: prev };
        }
    ...
    (function(mod) {
        ...
        function on(type, f) {
            var handlers = this._handlers || (this._handlers = Object_create(null));
    ...
    (function(mod) {
        ...
        var plugins = Object_create(null);
        ...
        var Server = exports.Server = function(options) {
            ...
            this.handlers = Object_create(null);
            this.files = [];
            this.uses = 0;
            this.pending = 0;
            this.asyncError = null;
            this.passes = Object_create(null);
    ...
    (function(mod) {
        ...
        function emptyObj(ctor) {
            var empty = Object_create(ctor.prototype);
            empty.props = Object_create(null);
            empty.isShell = true;
            return empty;
        }
        ...
        function doLoadEnvironment(data, scope) {
            ...
            cx.loading = data;
            cx.localDefs = cx.definitions[cx.curOrigin] = Object_create(null);
        ...
        // computation.
        var customFunctions = Object_create(null);
      ...
      WG_CATCH_ERROR = 5, WG_GLOBAL_THIS = 2, WG_SPECULATIVE_THIS = 2;
        ...
        AVal.prototype = extend(ANull, {
            ...
            getProp: function(prop) {
                ...
                var found = (this.props || (this.props = Object_create(null)))[prop];
                if (!found) {
            ...
            makeupType: function() {
                ...
                var props = Object_create(null), foundProp = null;
        ...
        var constraint = exports.constraint = function(props, methods) {
            ...
            ctor.prototype = Object_create(Constraint.prototype);
        ...
        var Obj = exports.Obj = function(proto, name) {
            if (!this.props) this.props = Object_create(null);
        ...
        Obj.prototype = extend(Type.prototype, {
            ...
            getProp: function(prop) {
                ...
                if (!this.maybeProps) {
                    ...
                    this.maybeProps = Object_create(null);
                }
        ...
        exports.Context = function(defs, parent) {
            this.parent = parent;
            this.props = Object_create(null);
            this.protos = Object_create(null);
            this.prim = Object_create(null);
            this.origins = [];
            this.curOrigin = "ecma5";
            this.paths = Object_create(null);
            this.definitions = Object_create(null);
            this.purgeGen = 0;
            this.workList = null;
                ...
                while (m = decl.exec(comment)) {
                    ...
                    switch (m[1]) {
                        ...
                        case "param": case "arg": case "argument":
                            ...
                            if (!name) continue;
                            (args || (args = Object_create(null)))[name[1]] = parsed.type;
