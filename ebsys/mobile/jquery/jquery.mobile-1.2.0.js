...
(function( $, window, undefined ) {
	...
	$.mobile = $.extend( {}, {
		...
		nsNormalize: function( prop ) {
			...
			try{return nsNormalizeDict[ prop ] || ( nsNormalizeDict[ prop ] = $.camelCase( $.mobile.ns + prop ) );}catch(e){}
		},
...
$.Widget.prototype = {
	...
	_setOption: function( key, value ) {
		try{this.options[ key ] = value;}catch(e){}
...
$.widget( "mobile.widget", {
	...
	_getCreateOptions: function() {
		...
		$.each( this.options, function( option ) {
			...
			if ( value !== undefined ) {
				try{options[ option ] = value;}catch(e){}
			}
		});
